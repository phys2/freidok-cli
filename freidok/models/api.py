...
#   filename:  freidok_schema_edited.json
#   timestamp: 2023-01-12T13:06:23+00:00
...
class Owner(BaseModel):
    """
    Information about authentification. ONLY VISIBLE FOR ADMINS OR OWNERS.
    """
...
class Abstract(BaseModel):
    ...
    """
    grouping of this entry. ONLY VISIBLE IF edit=true.
    """
...
class ClassificationsUncontrolledItem(BaseModel):
    """
    Entry for a classification-asssignment.
    """
    ...
    value: Optional[str] = None
    """
    description (and ID) of the classifications category to assign
    """
    grouping: Optional[int] = None
    """
    grouping of this entry. ONLY VISIBLE IF edit=true.
...
class Pubtype(BaseModel):
    """
    type of the publication. --> PROPOSED TO BE RENAMED TO pubtype
    """
...
class State(BaseModel):
    """
    NOT YET IMPLEMENTED. state of review and public availability
    """
...
class Issued(BaseModel):
    """
    NOT YET IMPLEMENTED. An explanation about the purpose of this instance. ONLY VISIBLE FOR ADMINS
    """
...
class License(BaseModel):
    ...
    An explanation about the purpose of this instance.
    """
    field__value: Annotated[Optional[str], Field(alias="__value")] = None
    """
    An explanation about the purpose of this instance.
    """
...
class File(BaseModel):
    ...
    An explanation about the purpose of this instance.
    """
    preview_image: Optional[PreviewImage1] = None
    """
    TODO. An explanation about the purpose of this instance.
    """
    ...
    An explanation about the purpose of this instance.
    """
    field_state: Annotated[Optional[str], Field(alias="_state")] = None
    """
    An explanation about the purpose of this instance.
    """
    field_state_value: Annotated[Optional[str], Field(alias="_state_value")] = None
    """
    An explanation about the purpose of this instance.
    """
    grouping: Optional[int] = None
...
class Doc(BaseModel):
    ...
    owner: Annotated[
        ...
        Field(
            examples=[
                {
                    "type_value": "authentifiziert per Lopes-TAN",
                    "type": "lopes_tan",
                    "value": "21212",
                }
            ]
    ...
    """
    classifications_uncontrolled: Optional[list[ClassificationsUncontrolledItem]] = None
    """
    List of classification-assignments for classifications, that are NOT imported to FreiDok plus.
    """
    pub_ids: Optional[list[PubId]] = None
    """
    List of identifiers for the publication. --> PROPOSED TO BE RENAMED TO pub_ids
    """
    ...
    """
    series: Annotated[
        Optional[Series], Field(examples=[{"value": "1", "volume": "2", "issue": "23"}])
    ] = None
    """
    Information about the series.
    """
